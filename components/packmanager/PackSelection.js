						...
						<>
							...
							marketInfo.market[0][0].price > 0 ? ( //if price is bigger than 0, show price
								...
								<div className='flex'>
									...
									<a
										href={`https://app.hro.gg/DC/marketplace/pack/${packTemplate.id}`}
										className='ml-1 flex items-center text-main-400 hover:underline'
										target='_blank'
										rel='noreferrer'
									>
							...
							<div>
								...
								{marketInfo.recentSales.slice(0, 4).map((sale) => (
									<div className='flex border-b border-gray-600' key={sale.updated}>
										<span className='text-main-400'>{sale.price} </span>
			...
			<div className='m-2 flex flex-1 flex-col overflow-auto'>
				<div className='my-2 flex items-center justify-around text-gray-800 dark:text-gray-300 sm:w-1/2'>
					<button
						...
						className='m-1 cursor-pointer rounded-md border border-gray-800 p-1 text-center text-gray-800 transition-colors hover:bg-gray-300 hover:text-gray-800 active:bg-gray-400 dark:border-gray-200 dark:text-gray-300 dark:hover:text-gray-700'
					>
					...
					<div className='flex items-center'>
						...
						>
							...
							<input
								...
								className='ml-2 rounded-md border border-gray-800 p-1 text-black focus:outline-main-400'
								onChange={(e) =>
									setSelected(
