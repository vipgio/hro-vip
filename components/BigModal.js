			...
			<div className='fixed inset-0 z-30 flex flex-col items-center justify-center overscroll-none bg-black/90'>
				...
				>
					<div className='relative flex h-12 w-full items-center border-b border-b-white/10 bg-gray-300 dark:bg-gray-800'>
						...
						<button
							className='ml-auto h-12 w-12 p-1 text-gray-900 transition-colors duration-300 hover:cursor-pointer hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-300 active:bg-green-300 active:text-main-400 dark:text-gray-200 dark:hover:bg-gray-700'
							onClick={close}
						>
							<svg
