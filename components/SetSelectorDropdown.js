...
const SetSelectorDropdown = ({ collections, setSelectedCollection }) => {
	...
	return (
		<div tabIndex={-1}>
			<Menu
				menuButton={
					<MenuButton className='m-2 box-border rounded-md border border-gray-300 bg-white p-2 text-sm text-gray-800 shadow-md transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-main-500 focus-visible:ring-offset-2 dark:bg-gray-800 dark:text-gray-100'>
						Select a collection
					</MenuButton>
				}
