	...
	return (
		<>
			<span className='pb-2 text-xl font-semibold text-gray-700 dark:text-gray-300'>
				Login using your Hro account jwt
			</span>
			<form
			...
			>
				...
				<div className='pr-2 text-gray-700 dark:text-gray-300'>
					<Tooltip
						text={
							"Your token is never stored or sent to anywhere other than Hro. If you have any questions you can check the source code or contact me on discord."
						}
						direction='right'
					/>
				</div>
